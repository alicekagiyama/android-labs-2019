...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        final MyImageView myImageView = (MyImageView) findViewById(R.id.alice_view);
        Button button_get = (Button) findViewById(R.id.button_load);
        button_get.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                myImageView.setImageURL("https://raw.githubusercontent.com/alicekagiyama/png-from-pixiv/master/alice_p"+new Random().nextInt(6) +".jpg");
            }
        });
        ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    }
